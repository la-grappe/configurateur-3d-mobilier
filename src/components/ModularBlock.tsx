...
import { MODULE_SIZES, FRAME_COLOR } from '../constants/modules';
...
const InteractiveFace: React.FC<InteractiveFaceProps> = memo(({ moduleId, size, position, rotation, index, storedColor }) => {
...
const ModularBlock: React.FC<ModularBlockProps> = memo(({ id, type, position = [0, 0, 0], color = "#ffffff", faceColors = {} }) => {
